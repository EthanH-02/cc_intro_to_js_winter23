...
function printPrologue() {
    ...
    */
    ...
    console.log('The Legend of Zelda by EthanH-02')
}
...
function movingLink(link_x, link_y, dx, dy) {
    ...
    */
    ...
    const new_x = link_x + dx
    const new_y = link_y + dy
...
function titleOfTheHero()  {
    ...
    */
    ...
    console.log()
    const hero_of = prompt('The valiant hero Link, commonly known to the lands as The Hero of ')
